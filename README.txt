...
1.5.1:
-- Use Javascript to fade old text out and new text in. For more details, see: http://stackoverflow.com/questions/6305667/change-text-html-with-animate
AND (more importantly)
http://jsfiddle.net/jWcLz/1/
-- #randomQuoteButton:hover
-- TODO: Ideas: Have the color of the #randomQuoteButton:hover effect be on the opposite side of the color wheel
-- Fix problems with colons (":") and new line characters ("\n")
